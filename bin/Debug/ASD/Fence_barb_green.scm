...
;Name=Fence_barb_green, Type=General Objects, Bitmap=fence_barb_green.jpg, \
;Latitude, Longitude, Range=30, \
;Density=2, Visibility=10000, Elevation=0, Rotation=0, \
;Scale=1, Width=2, Height=2, Length=20, Texture=fence_barb_green.bmp, \
...
UVar( $H0 0 )    ; ground
UVar( $H1 %10 )	 ; height
Uvar( $HM [ $H1 * 0.725 ] )  ; half height
Uvar( $D [0.1333 * $H1] )    ; shift for the higher points
...
; one face
    [$WN] [$H0] 0    0 0     -1     0    0
    [$WP] [$H0] 0    0 0     -1     [$T] 0
    [$WP] [$HM] 0    0 0     -1     [$T] 0.725
    [$WN] [$HM] 0    0 0     -1     0    0.725
    [$WN] [$HM] 0    0 0.412 -0.911 0    0.725
    [$WP] [$HM] 0    0 0.412 -0.911 [$T] 0.725
    [$WP] [$H1] [$D] 0 0.412 -0.911 [$T] 1
    [$WN] [$H1] [$D] 0 0.412 -0.911 0    1
; the other face
    [$WN] [$HM] 0    0 0      1     0    0.725
    [$WP] [$HM] 0    0 0      1     [$T] 0.725
    [$WP] [$H0] 0    0 0      1     [$T] 0
